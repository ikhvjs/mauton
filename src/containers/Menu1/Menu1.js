...
const mapStateToProps = (state) => {
	return {
		...
		itemPerPage: state.menu1Rdc.itemPerPage,
		displayMenu1: state.menu1Rdc.displayMenu1,
		selectedPage: state.menu1Rdc.selectedPage,
	}
}
